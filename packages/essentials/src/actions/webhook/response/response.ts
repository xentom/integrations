...
import { responses } from '../webhook.utils';

const category = {
  path: ['Webhook', 'Response'],
} satisfies i.ActionCategory;

export const textWebhookResponse = i.actions.callable({
  category,
...
export const jsonWebhookResponse = i.actions.callable({
  category,
...
export const redirectWebhookResponse = i.actions.callable({
  category,
