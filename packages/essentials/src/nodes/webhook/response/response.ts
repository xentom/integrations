...
export const textWebhookResponse = i.nodes.callable({
  category,
...
export const jsonWebhookResponse = i.nodes.callable({
  category,
...
export const redirectWebhookResponse = i.nodes.callable({
  category,
