...
export const createResponse = i.actions.callable({
  category,
  inputs: {
    model: i.pins.data({
...
export const getResponse = i.actions.callable({
  category,
  inputs: {
...
export const cancelResponse = i.actions.callable({
  category,
  inputs: {
    responseId: customPins.responseId,
  },
...
export const deleteResponse = i.actions.callable({
  category,
  inputs: {
    responseId: customPins.responseId,
  },
