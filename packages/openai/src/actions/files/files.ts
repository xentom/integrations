...
export const createFile = i.actions.callable({
  category,
  inputs: {
...
export const deleteFile = i.actions.callable({
  category,
  inputs: {
...
export const listFiles = i.actions.callable({
  category,
  inputs: {
    limit: i.pins.data({
...
export const getFile = i.actions.callable({
  category,
  inputs: {
    fileId: customPins.fileId,
  },
...
export const fileContent = i.actions.callable({
  category,
  inputs: {
    fileId: customPins.fileId,
  },
...
export const waitForFileProcessing = i.actions.callable({
  category,
  inputs: {
    fileId: customPins.fileId,
