...
// Create Contact
export const createContact = i.actions.callable({
  category,
...
export const getContact = i.actions.callable({
  category,
...
export const listContacts = i.actions.callable({
  category,
...
export const updateContact = i.actions.callable({
  category,
...
export const deleteContact = i.actions.callable({
  category,
