...
export const getAllLists = nodes.callable({
...
export const getList = nodes.callable({
...
export const createList = nodes.callable({
...
export const updateList = nodes.callable({
...
export const deleteList = nodes.callable({
